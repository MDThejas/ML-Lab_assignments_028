...
# Datatypes
# age, TSH, T3, TT4, T4U, FTI and TBG are numeric.
# Remaining attributes are categorical (Nominal).
# No ordinal attributes are there .

# Encoding
# One-Hot Encoding can be used for categorical attributes.
# Label Encoding for binary (t/f) attributes.

# Data Range
# Numeric columns have different ranges.
# Age and thyroid test values have huge different ranged vlaues which can be an error too.

# Missing Values
# Missing values are represented by '?'.
# These should be replaced with NaN before finding mean or variance.

# Outliers
# Some numeric columns like Age, TSH and TT4 contain extreme values.
# These values can be treated as outliers.
